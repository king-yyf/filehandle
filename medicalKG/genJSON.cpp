...
int main()
{
    FILE * f1 = fopen("/Users/yangyf/Desktop/all_name_v2.txt", "r");
    FILE * f2 = fopen("/Users/yangyf/Desktop/all_rel_v2.txt", "r");
    ...
    for(it = idMap.begin(); it != idMap.end(); it++)
    {
        ...
        id = it->second;
        pId = 0;
        fprintf(f3, "{ \"id\":%d, \"pId\":%d, \"name\":\"%s\", \"open\":false, \"icon\":\"static/images/class.gif\"},\n", id,pId,tmp.data());
    }
    ...
    while (fscanf(f2, "%s %s %d", key, super,&has_child) == 3) {
        ...
        {
            fprintf(f3, "{ \"id\":%d, \"pId\":%d, \"name\":\"%s\", \"icon\":\"static/images/datarange.png\"},\n", id,pId,key);
        }
    }
    fclose(f2);
    printf("count = %d\n",count);
